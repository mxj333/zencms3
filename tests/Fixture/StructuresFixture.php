...
class StructuresFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'name' => ['type' => 'string', 'length' => 20, 'null' => true, 'default' => '', 'comment' => '名称', 'precision' => null, 'fixed' => null],
        'label' => ['type' => 'string', 'length' => 20, 'null' => false, 'default' => '', 'comment' => '中文显示', 'precision' => null, 'fixed' => null],
        'icon' => ['type' => 'string', 'length' => 20, 'null' => true, 'default' => '', 'comment' => 'calss名', 'precision' => null, 'fixed' => null],
